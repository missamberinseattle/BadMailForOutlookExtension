...
namespace BadMailForOutlook {
    ...
    public sealed partial class BadMailAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public BadMailAddIn(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
                base(factory, serviceProvider, "AddIn", "BadMailAddIn") {
    ...
    internal sealed partial class Globals {
        ...
        private static BadMailAddIn _BadMailAddIn;
        ...
        internal static BadMailAddIn BadMailAddIn {
            get {
                return _BadMailAddIn;
            }
            set {
                if ((_BadMailAddIn == null)) {
                    _BadMailAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.BadMailAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.BadMailAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.BadMailAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
